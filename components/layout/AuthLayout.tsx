  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-primary-navy flex-col justify-between p-12">
        ...
        <div className="relative z-10">
          <Link href="/" className="inline-flex items-center space-x-2">
            <div className="w-10 h-10 bg-primary-orange rounded-xl flex items-center justify-center shadow-lg shadow-primary-orange/30">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 relative">
        ...
        <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-8 duration-1000 mt-12 lg:mt-0">
          {children}
        </div>
      </div>
    </div>
