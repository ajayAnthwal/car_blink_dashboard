...
export default function AccountsDashboardPage() {
  ...
  // Check if everything is completely empty (no financial data ever)
  const isTotallyEmpty = stats.totalRefundsAmount === 0 && stats.totalSettlementsAmount === 0 && stats.pendingRefunds === 0 && stats.pendingSettlements === 0;
    ...
    <div className="max-w-7xl mx-auto space-y-6 pb-10 animate-in fade-in duration-500">
      ...
      {isTotallyEmpty ? (
        <div className="mt-10 bg-white rounded-2xl shadow-subtle border border-gray-100 p-12 text-center flex flex-col items-center justify-center max-w-2xl mx-auto">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2 font-heading">No Financial Activity Found</h2>
          <p className="text-gray-500 font-body max-w-md">There are currently no refunds or settlements processed in the system.</p>
        </div>
      ) : (
        <>
          {/* Quick Stats Grid */}
